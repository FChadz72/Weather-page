...
function displayHourlyForecast(hourlyData) {
    const hourlyForecastDiv = document.getElementById('hourly-forecast');
    const next24Hours = hourData.slice(0, 8);
    ...
    next24Hours.forEach(item => {
       ...
       const hourlyItemHtml = '<div class="hourly-item"> <span><${hour}</span>  <img scr="${iconUrl}" alt="Hourly Weather Icon"></img> <span>${temperature}</span> </div>';
